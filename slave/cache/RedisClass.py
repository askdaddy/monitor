...
ConnPool = redis.ConnectionPool(host = settings.rhost, port = settings.rport, db = settings.rdb)
...
class OtherRedis(RedisConn):
    ...
    def __init__(self, namespace = '', ):
        RedisConn.__init__(self, namespace, data_type = 'Queue_or_Hash_or_other')
